...
return (
    <div className="mb-20 flex flex-col sm:mb-0 mx-5" >
...
useCountUp({ ref: "certifications", end: 4, duration: 2 });
...
return (
    ...
    <div className="container mx-auto">
        ...
        <div className="sm:overflow-auto mt-10 sm:mt-0 md:mt-0 w-full lg:w-3/4 sm:w-2/4 md:w-2/4 text-left">
            ...
            <div className="container mx-auto py-3 block sm:flex sm:justify-between items-center" style={{ display:"flex", justifyContent:'center' }}>
